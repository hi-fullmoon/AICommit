...
> 2026-08-27 范围校正：实际交付暴露了过多外围能力。后续版本重新聚焦 setup、doctor、commit、团队规范和文件级 split；移除本地指标、可执行扩展、独立 preset 生命周期及实验性 hunk 规划入口。下方 v1.x 记录保留为历史交付背景，不表示所有能力仍属于当前产品面。
...
| v2.1   | 🚧 收敛中 | 去除低价值外围能力，缩短主帮助与 README，保留文件级 split 和旧计划恢复兼容              |
